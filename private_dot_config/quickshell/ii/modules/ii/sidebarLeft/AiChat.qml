        ...
        Item {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    StatusItem {
                        icon: Ai.currentModelUsesCodex ? "openai-symbolic" : (Ai.currentModelHasApiKey ? "key" : "key_off")
                        statusText: ""
                        description: Ai.currentModelUsesCodex ? Translation.tr("Uses your current Codex login\nNo separate API key is needed") : (Ai.currentModelHasApiKey ? Translation.tr("API key is set\nChange with /key YOUR_API_KEY") : Translation.tr("No API key\nSet it with /key YOUR_API_KEY"))
                    }
                    StatusSeparator {
                        visible: !Ai.currentModelUsesCodex
                    }
                    StatusItem {
                        visible: !Ai.currentModelUsesCodex
        ...
        Rectangle { // Input area
            ...
            RowLayout { // Controls
                ...
                ApiInputBoxIndicator {
                    ...
                    text: Ai.currentToolDisplay.charAt(0).toUpperCase() + Ai.currentToolDisplay.slice(1)
                    tooltipText: Ai.currentModelUsesCodex ? Translation.tr("Codex native tools\nRestricted to a read-only sandbox") : Translation.tr("Current tool: %1\nSet it with %2tool TOOL").arg(Ai.currentTool).arg(root.commandPrefix)
                }
