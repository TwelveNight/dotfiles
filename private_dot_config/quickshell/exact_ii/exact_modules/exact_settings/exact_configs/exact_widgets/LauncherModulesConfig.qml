    ...
    ContentPage {
        ...
        ContentSection {
            ...
            ColumnLayout {
                ...
                ConfigSwitch { buttonIcon: "speed"; text: Translation.tr("Speed test"); description: Translation.tr("Search for ‘speed’, ‘velocidade’, ‘network velocity’, or type prefix ‘%1’.").arg(String(Config.options.search.prefix.speedTest)); checked: Config.options.search.modules.speedTest.enable; onCheckedChanged: Config.options.search.modules.speedTest.enable = checked }
