...
/**
 * Material 3 Expressive time picker: typed fields on top, clock dial underneath.
 *
...
Item {
    ...
    function syncInputs() {
        ...
        hourInput.text = root.pad2(root.displayHour);
        minuteInput.text = root.pad2(root.minute);
                ...
                Item {
                    ...
                    Repeater {
                        ...
                        delegate: StyledText {
                            ...
                            text: root.stage === 1 ? root.pad2(slotValue) : String(slotValue)
                            font.family: Appearance.font.family.numbers
