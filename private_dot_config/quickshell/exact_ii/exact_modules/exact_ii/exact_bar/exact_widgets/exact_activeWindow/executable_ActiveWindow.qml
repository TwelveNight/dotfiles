...
Item {
    ...
    implicitHeight: root.vertical && isFixedSize ? fixedSize : (root.vertical ? Math.max(incomingClassText.implicitWidth, incomingTitleText.implicitWidth) + 20 : Appearance.sizes.baseBarHeight)
    implicitWidth: !root.vertical && isFixedSize ? fixedSize : (root.vertical ? Appearance.sizes.verticalBarWidth : Math.min(Math.max(incomingClassText.implicitWidth, incomingTitleText.implicitWidth) + 20, maxSize))
    clip: true
    ...
    Item {
        ...
        ColumnLayout {
            ...
            StyledText {
                ...
                color: Appearance.colors.colSubtext
                elide: Text.ElideRight
                text: root.outgoingClass
            }

            StyledText {
                id: outgoingTitleText
                Layout.leftMargin: root.vertical ? 0 : 6
                Layout.fillWidth: true
                font.pixelSize: Appearance.font.pixelSize.small
                color: Appearance.colors.colOnLayer0
